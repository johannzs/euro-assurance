    ...
    if(callback === ''){
        ...
        script.onload = function(){
            if(console && console.log){
                console.log('[Loaded] '+getJsBaseUrl()+'deployments/20190408170540275/assembly.min.js')
            }
        };
        script.src = getJsBaseUrl()+'deployments/20190408170540275/assembly.min.js';
        ...
        xmlHttp.open( "GET", getJsBaseUrl() + 'deployments/20190408170540275/assembly.min.js', false );
        xmlHttp.send( null );
...
/*
     FILE ARCHIVED ON 03:09:41 Jul 18, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 11:48:24 Jul 07, 2021.
...
playback timings (ms):
  ...
  esindex: 0.007
  LoadShardBlock: 144.139 (3)
  PetaboxLoader3.datanode: 204.604 (4)
  CDXLines.iter: 28.788 (3)
  load_resource: 215.75
  PetaboxLoader3.resolve: 83.273
*/